...
export default function GuardVehicleNotifications() {
  ...
  return (
    <div className="fixed top-28 right-8 z-[9999]">
      {/* 🔔 Bell */}
      <button
        onClick={() => setOpen(!open)}
        className="relative bg-white p-3 rounded-full shadow-xl hover:scale-110 transition"
      >
      ...
      {/* 🔽 Dropdown */}
      {open && (
        <div className="mt-4 w-96 bg-white rounded-2xl shadow-2xl p-4 space-y-3">
